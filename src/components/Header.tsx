        ...
        <div className="max-w-[1440px] mx-auto px-6 h-full flex justify-between items-center">
          <a href="/" className="flex items-center gap-3 group">
            ...
            <div className="flex flex-col">
              <span className="font-serif text-2xl font-medium tracking-tight leading-none group-hover:text-black transition-colors">
                Sajith M
              </span>
              <span className="text-[9px] uppercase text-center tracking-[0.15em] text-[#5C5C56] mt-0.5">
                Advocate
              </span>
            </div>
          </a>
